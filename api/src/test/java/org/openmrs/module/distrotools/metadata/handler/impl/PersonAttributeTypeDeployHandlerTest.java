...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.personAttributeType;
...
public class PersonAttributeTypeDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(personAttributeType("New name", "New desc", String.class, null, false, 1, "obj-uuid"));
		...
		distroToolsService.installObject(personAttributeType("Updated name", "Updated desc", String.class, null, false, 1, "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(PersonAttributeType.class, "obj-uuid"), "Testing");
		...
		distroToolsService.installObject(personAttributeType("Unretired name", "Unretired desc", String.class, null, false, 1, "obj-uuid"));
