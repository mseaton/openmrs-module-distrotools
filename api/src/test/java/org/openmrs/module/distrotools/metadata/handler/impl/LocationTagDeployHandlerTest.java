...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.locationTag;
...
public class LocationTagDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(locationTag("New name", "New desc", "obj-uuid"));
		...
		distroToolsService.installObject(locationTag("Updated name", "Updated desc", "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(LocationTag.class, "obj-uuid"), "Testing");

		Assert.assertThat(locationService.getLocationTagByUuid("obj-uuid"), nullValue());

		// Check re-install re-creates
		distroToolsService.installObject(locationTag("Unpurged name", "Unpurged desc", "obj-uuid"));
