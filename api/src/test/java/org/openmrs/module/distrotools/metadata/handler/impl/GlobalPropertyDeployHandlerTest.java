...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.globalProperty;
...
public class GlobalPropertyDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(globalProperty("test.property", "Testing", "Value"));
		...
		distroToolsService.installObject(globalProperty("test.property", "New desc", "New value"));
		...
		distroToolsService.installObject(globalProperty("test.property", "Other desc", null));
		...
		distroToolsService.installObject(globalProperty("test.property", "Other desc", ""));
		...
		distroToolsService.installObject(globalProperty("test.property2", "Testing", TestingDatatype.class, "config", null));
		...
		distroToolsService.installObject(encounterType("Test Encounter", "Testing", "enc-type-uuid"));

		EncounterType encType = Context.getEncounterService().getEncounterTypeByUuid("enc-type-uuid");

		distroToolsService.installObject(globalProperty("test.property2", "Testing", TestingDatatype.class, "config", encType));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(GlobalProperty.class, "test.property"), "Testing");
		...
		distroToolsService.installObject(globalProperty("test.property", "Unretired desc", "Unretired value"));
