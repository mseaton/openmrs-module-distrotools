...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.providerAttributeType;
...
public class ProviderAttributeTypeDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(providerAttributeType("New name", "New desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
		...
		distroToolsService.installObject(providerAttributeType("Updated name", "Updated desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(ProviderAttributeType.class, "obj-uuid"), "Testing");

		Assert.assertThat(providerService.getProviderAttributeTypeByUuid("obj-uuid").isRetired(), is(true));

		// Check re-install unretires
		distroToolsService.installObject(providerAttributeType("Unretired name", "Unretired desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
