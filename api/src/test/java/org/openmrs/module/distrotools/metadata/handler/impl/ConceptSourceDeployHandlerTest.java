...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.conceptSource;
...
public class ConceptSourceDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(conceptSource("New name", "New desc", "New code", "obj-uuid"));
		...
		distroToolsService.installObject(conceptSource("Updated name", "Updated desc", "Updated code", "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(ConceptSource.class, "obj-uuid"), "Testing");

		Assert.assertThat(Context.getConceptService().getConceptSourceByUuid("obj-uuid").isRetired(), is(true));

		// Check re-install unretires
		distroToolsService.installObject(conceptSource("Unretired name", "Unretired desc", "Unretired code", "obj-uuid"));
