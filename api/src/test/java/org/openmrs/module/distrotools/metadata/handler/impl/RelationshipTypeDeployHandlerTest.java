...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.relationshipType;
...
public class RelationshipTypeDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(relationshipType("New AtoB", "New BtoA", "New desc", "obj-uuid"));
		...
		distroToolsService.installObject(relationshipType("Updated AtoB", "Updated BtoA", "Updated desc", "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(RelationshipType.class, "obj-uuid"), "Testing");
		...
		distroToolsService.installObject(relationshipType("Unretired AtoB", "Unretired BtoA", "Unretired desc", "obj-uuid"));
