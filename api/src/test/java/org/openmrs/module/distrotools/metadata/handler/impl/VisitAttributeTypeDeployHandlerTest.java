...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.visitAttributeType;
...
public class VisitAttributeTypeDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(visitAttributeType("New name", "New desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
		...
		distroToolsService.installObject(visitAttributeType("Updated name", "Updated desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(VisitAttributeType.class, "obj-uuid"), "Testing");
		...
		distroToolsService.installObject(visitAttributeType("Unretired name", "Unretired desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
