...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.program;
...
public class ProgramDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(program("Test Program", "Testing", HIV_PROGRAM_UUID, "obj1-uuid"));
		...
		distroToolsService.installObject(program("New name", "New desc", MALARIA_PROGRAM_UUID, "obj1-uuid"));
		...
		distroToolsService.installObject(program("New name", "Diff desc", MALARIA_PROGRAM_UUID, "obj2-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(Program.class, "obj2-uuid"), "Testing");
		...
		distroToolsService.installObject(program("Unretired name", "Unretired desc", MALARIA_PROGRAM_UUID, "obj2-uuid"));
