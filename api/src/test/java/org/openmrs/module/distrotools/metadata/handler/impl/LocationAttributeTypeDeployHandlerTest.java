...
import static org.openmrs.module.distrotools.metadata.bundle.CoreConstructors.locationAttributeType;
...
public class LocationAttributeTypeDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		distroToolsService.installObject(locationAttributeType("New name", "New desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
		...
		distroToolsService.installObject(locationAttributeType("Updated name", "Updated desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
		...
		distroToolsService.uninstallObject(distroToolsService.fetchObject(LocationAttributeType.class, "obj-uuid"), "Testing");
		...
		distroToolsService.installObject(locationAttributeType("Unretired name", "Unretired desc", FreeTextDatatype.class, null, 0, 1, "obj-uuid"));
